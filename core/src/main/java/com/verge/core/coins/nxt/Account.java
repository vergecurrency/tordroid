...
//                + " existing key " + com.verge.core.coins.nxt.Convert.toHexString(account.getPublicKey()) + " new key " + com.verge.core.coins.nxt.Convert.toHexString(publicKey));
//    }
...
//        if (id != com.verge.core.coins.nxt.Crypto.rsDecode(com.verge.core.coins.nxt.Crypto.rsEncode(id))) {
...
//        name = com.verge.core.coins.nxt.Convert.emptyToNull(name.trim());
//        description = com.verge.core.coins.nxt.Convert.emptyToNull(description.trim());
...
//            data = com.verge.core.coins.nxt.Convert.compress(data);
//        }
//        return EncryptedData.encrypt(data, com.verge.core.coins.nxt.Crypto.getPrivateKey(senderSecretPhrase), getPublicKey());
//    }
//
...
//        }
//        byte[] decrypted = encryptedData.decrypt(com.verge.core.coins.nxt.Crypto.getPrivateKey(recipientSecretPhrase), getPublicKey());
//        if (uncompress && decrypted.length > 0) {
//            decrypted = com.verge.core.coins.nxt.Convert.uncompress(decrypted);
//        }
//        return decrypted;
//    }
//
